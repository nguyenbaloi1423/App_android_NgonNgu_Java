...
public class zChiaSeChoThayDiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chia_se_cho_thay_di);
    ...
    private Uri getmageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            outputStream.flush();
            outputStream.close();
            uri = FileProvider.getUriForFile(this, "com.example.asmandroidnangcaops22938", file);
        } catch (Exception e) {
